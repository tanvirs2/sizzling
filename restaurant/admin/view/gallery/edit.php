...
$sqlImage = "SELECT banner_image FROM tbl_gallery WHERE banner_id= $banner_id";
...
if (isset($_POST['banner_title'])) {
    ...
    // check banner exist
    $sql_check = "SELECT * FROM tbl_gallery WHERE banner_title='$banner_title' AND banner_id NOT IN (" . $banner_id . ")";
...
// getting banner data
$sqlData = "SELECT * FROM tbl_gallery WHERE banner_id = $banner_id";
