                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-group">
                        <div class="panel panel-primary" style="border-color: #6BA756;">
                            <div class="panel-heading panel-style"  style="background-color: #6BA756;text-transform: uppercase;font-weight: bold">Add Menu Category</div>
                    ...
                    <div class="panel-group">
                        <div class="panel panel-primary" style="border-color: #6BA756;">
                            <div class="panel-heading panel-style"  style="background-color: #6BA756;text-transform: uppercase;font-weight: bold">Menu Category List</div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped" id="categoryTable">
                                        ...
                                        <?php while ($obj = mysqli_fetch_object($result)): ?>
                                            <tr>
                                                <td style="width: 30%;"><?php echo $obj->product_category_name; ?></td>
                                                <td style="width: 20%;">
                                                ...
                                                <td style="width: 20%;">
                                                    <a href="<?php echo baseUrl('admin/view/menu_category/edit.php?id='); ?><?php echo $obj->product_category_id; ?>">
