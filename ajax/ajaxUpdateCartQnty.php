...
if ($id > 0 && $id != '') {
    ...
    if($resultCurrQty){
        ...
        if ($result) {
            ...
            $return_array = array("output" => "success", "msg" => "Quantity Updated","arrTmpCart" => $arrTmpCart, "totalCartAmount" => number_format($totalCartAmount, 2) );
            echo json_encode($return_array);
            exit();

        }
//        $return_array = array("output" => "success", "msg" => "Item test", "arrTmpCart" => $test);
//        echo json_encode($return_array);
    } else{
