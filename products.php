...
$sqlProduct = "SELECT * FROM tbl_product WHERE product_title='$product_id' ";
...
if (isset($_POST['add_to_cart'])) {
    ...
    if ($product_quantity === '') {
        ...
        $sqlCheckTempOrder = "SELECT * FROM tbl_temp_order "
            . "WHERE temp_order_session_id='$temp_order_session_id' AND "
            . "temp_order_product_id=$product_id ";
        $resultCheckTempOrder = mysqli_query($con, $sqlCheckTempOrder);
        $countTempOrder = mysqli_num_rows($resultCheckTempOrder);
        if ($countTempOrder > 0) {
            $customArray = '';
            $customArray .= 'temp_order_product_qty = "' . ++$product_quantity . '"';
            $sqlUpdateQuantity = "UPDATE tbl_temp_order SET $customArray WHERE temp_order_product_id= '$product_id' AND temp_order_session_id = '$temp_order_session_id'";
...
<head>
    ...
    <?php if ($objProduct->product_description == ''){ ?>
    ...
    <?php } ?>
    <?php if ($objProduct->product_keywords == ''){ ?>
    ...
    <?php } ?>
    <meta name="description" content="<?php echo $objProduct->product_description; ?>">
    <meta name="keywords" content="<?php echo $objProduct->product_keywords; ?>">
                        ...
                        <div class="product__big__images">
                            <div class="portfolio-full-image tab-content">
                                <div role="tabpanel" class="tab-pane fade in active" id="img-tab-1">
                                    ...
                                    <?php endif; ?>
                                    <img src="upload/product_image/<?php echo $objProduct->product_image; ?>" alt="<?php echo $objProduct->product_title; ?>" onerror="this.src='images/no-image-available.jpg';">
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="htc__product__details__inner">
                        ...
                        <ul class="pro__dtl__prize">
                            <?php if($objProduct->product_old_price != '0.00') : ?>
                                <li class="old__prize">৳<?php echo $objProduct->product_new_price; ?></li>
                                <li>৳<?php echo $objProduct->product_old_price; ?></li>
                            <?php else: ?>
