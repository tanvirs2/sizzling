...
if (isset($_POST['btnContact'])) {
    ...
    if (empty($contact_name)) {
        ...
        $error = 'Your email eddress Required';
    } elseif (!isValidEmail($contact_email)) {
        $error = 'Invalid email format given';
    } elseif (empty($contact_message)) {
        $error = 'Message required';
    } else {
        $insertarray = '';
        $insertarray .= 'contact_name = "' . $contact_name . '"';
        $insertarray .= ',contact_email = "' . $contact_email . '"';
        $insertarray .= ',contact_subject = "' . $contact_subject . '"';
        $insertarray .= ',contact_message = "' . $contact_message . '"';
        $insertarray .= ',contact_created_on = "' . $contact_created_on . '"';

        $sql = "INSERT INTO tbl_contact SET $insertarray";
...
<head>
    ...
    <title>Contact Us &#8211; Sizzling</title>
        ...
        <div class="container">
            <div class="pagination-area">
                ...
                <div class="redchili-pagination"><!-- Breadcrumb NavXT 6.0.4 -->
                    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Sizzling." href="index.php" class="home"><span property="name">Sizzling</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name">Contact</span><meta property="position" content="2"></span></div>							</div>
        </div>
    </div>
                            ...
                            <div class="vc_row wpb_row vc_row-fluid"><div class="wpb_column vc_column_container vc_col-sm-12"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="wpb_gmaps_widget wpb_content_element">
                                                <div class="wpb_wrapper">
                                                    <div class="wpb_map_wraper">
                                                        <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2479.760874567673!2d0.12404921538829476!3d51.572617079645866!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x47d8a5079236126f%3A0x2e9b892e44f50aca!2sSizzling+Cafe+%26+RESTAURANT!5e0!3m2!1sen!2sbd!4v1566382866451!5m2!1sen!2sbd" style="border: 0px none; pointer-events: none;" allowfullscreen="" width="600" height="450" frameborder="0"></iframe>		</div>
                                                </div>
                                            </div>
                                        </div></div></div></div>
                            <div class="vc_row wpb_row vc_row-fluid vc_custom_1496984864421"><div class="wpb_column vc_column_container vc_col-sm-4"><div class="vc_column-inner "><div class="wpb_wrapper"><div class="contact-us-left ">
                                                ...
                                                <ul>
                                                    ...
                                                    <li>
                                                        ...
                                                        <h3>Phone</h3>
                                                        <p>T: +44 20 8590 4858</p>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-map-marker" aria-hidden="true"></i>
                                                        <h3>Address</h3>
                                                        <p> 71, Chadwell heath lane, Romford, United Kingdom</p>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-envelope-o" aria-hidden="true"></i>
                                                        <h3>E-mail</h3>
                                                        <p>71sizzling@gmail.com</p>
                                                    </li>
                                                    <li>
                                                        <i class="fa fa-share-alt" aria-hidden="true"></i>
                                                        <h3>Follow Us</h3>
                                                        <ul class="contact-social">
                                                            <li><a target="_blank" href="https://www.facebook.com/sizzling2019/"><i class="fa fa-facebook"></i></a></li>
                                ...
                                <div class="wpb_column vc_column_container vc_col-sm-8"><div class="vc_column-inner "><div class="wpb_wrapper"><div role="form" class="wpcf7" id="wpcf7-f277-p433-o1" dir="ltr" lang="en-US">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <span><input class="wpcf7-text form-control" placeholder="Name*" type="text" name="contact_name" value="<?php echo $contact_name; ?>" required="required"></span>
                                                                    </div></div>
                                                                <div class="col-sm-6">
                                                                    <div class="form-group">
                                                                        <span><input class="wpcf7-text form-control" placeholder="Email*" type="email" name="contact_email" value="<?php echo $contact_email; ?>" required="required"></span>
                                                                    </div></div>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <span><input class="wpcf7-text wpcf7-validates-as-required form-control" placeholder="Subject" type="text" name="contact_subject" value="<?php echo $contact_subject; ?>"></span>
                                                                    </div></div>
                                                                <div class="col-sm-12">
                                                                    <div class="form-group">
                                                                        <span><textarea name="contact_message" cols="20" rows="6" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required form-control" placeholder="Message*" required="required"><?php echo $contact_message; ?></textarea></span>
                                                                    </div></div>
                                                                <div class="col-lg-4 col-md-4 col-sm-6 col-sm-12">
                                                                    <div class="form-group margin-bottom-none">
                                                                        <input value="Send" class="wpcf7-form-control ghost-on-hover-btn"  name="btnContact" type="submit"><span class="ajax-loader"></span>
                                                                    </div></div>
                                                            </div></div>
                                                    </div>
