...
<head>
    ...
    <title>Product  List | <?php echo $config['ADMIN_SITE_NAME']; ?></title>
                ...
                <div class="col-md-12">
                    ...
                    <div class="panel-group">
                        <div class="panel panel-primary" style="border-color: #6BA756;">
                            <div class="panel-heading panel-style" style="background-color: #6BA756;text-transform: uppercase;font-weight: bold">Product List <a href="<?php echo baseUrl('admin/view/product/add.php'); ?>" class="label label-success" style="float: right;background-color: black !important;"><i class="fa fa-plus"></i>&nbsp;Add Product</a></div>
...
//                                            . "LEFT JOIN tbl_product_collection ON tbl_product.product_collection_id=tbl_product_collection.product_category_id "
...
<!--                                                --><?php //debug($obj); ?>
                                                <tr>
                                                    ...
                                                    <td style="width: 8%;"><?php echo $obj->product_sku; ?></td>
                                                    <td style="width: 6%;"><?php echo $obj->product_stock_quantity; ?></td>
                                                    <td style="width: 10%;"><?php echo $obj->product_category_name; ?></td>
                                                    <td style="width: 8%;"><?php echo $obj->product_buying_price; ?></td>
                                                    <td style="width: 10%;"><?php echo $obj->product_new_price; ?></td>
<!--                                                    <td style="width: 10%;">--><?php //echo $obj->product_old_price; ?><!--</td>-->
                                                    <td style="width: 10%;">
                                                    ...
                                                    <td style="width: 25%;">
                                                        <a href="<?php echo baseUrl('admin/view/product/view.php?id='); ?><?php echo $obj->product_id; ?>">
                                                            <button class="btn btn-warning btn-sm"><i class="fa fa-eye"></i>&nbsp;View</button>
                                                        </a>
                                                        <a href="<?php echo baseUrl('admin/view/product/edit.php?id='); ?><?php echo $obj->product_id; ?>">
