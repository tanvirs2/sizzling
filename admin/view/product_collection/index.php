...
if (isset($_POST['btnAddCategory'])) {
    ...
    $product_category_keywords = validateInput($product_category_keywords);
    $product_category_description = validateInput($product_category_description);
    $product_category_status = validateInput($product_category_status);
    if ($product_category_name === '') {
        ...
        $checkCategorySql = "SELECT * FROM tbl_product_collection WHERE product_category_name = '$product_category_name'";
        ...
        if ($countCategory >= 1) {
            ...
            $sqlInsertCategory = "INSERT INTO tbl_product_collection SET $customArray";
...
if (isset($_POST['DeleteCategory'])) {
    extract($_POST);
    $sql = "DELETE FROM tbl_product_collection WHERE product_category_id=$product_category_id";
...
<head>
    ...
    <title>Product Collection | EIGHTEEN</title>
                ...
                <div class="col-md-12">
                    <div class="panel-group">
                        <div class="panel panel-primary" style="border-color: #6BA756;">
                            <div class="panel-heading panel-style"  style="background-color: #6BA756;text-transform: uppercase;font-weight: bold">Product Collection List</div>
                            <div class="panel-body">
                                <div class="table-responsive">
                                    <table class="table table-bordered table-striped" id="categoryTable">
                                        ...
                                        <?php
                                        $array = array();
                                        $sql = "SELECT * FROM tbl_product_collection ORDER BY product_category_id DESC";
                                        $result = mysqli_query($con, $sql);
                                        ...
                                        <?php while ($obj = mysqli_fetch_object($result)): ?>
                                            <tr>
                                                ...
                                                <td style="width: 20%;">
                                                    <a href="<?php echo baseUrl('admin/view/product_collection/edit.php?id='); ?><?php echo $obj->product_category_id; ?>">
                    ...
                    <div class="panel-group">
                        <div class="panel panel-primary" style="border-color: #6BA756;">
                            <div class="panel-heading panel-style"  style="background-color: #6BA756;text-transform: uppercase;font-weight: bold">Add Product Collection</div>
                            <div class="panel-body">
                                <form class="form-group" method="POST" action="">
                                    <div class="form-group">
                                        <label for="product_category_name">Collection Name <span style="color: red;">*</span></label>
                                    ...
                                    <div class="form-group">
                                        <label for="product_category_keywords">SEO Keyword <span style="color: red;">*</span></label>
                                        <input type="text" class="form-control" id="product_category_keywords" name="product_category_keywords" value="<?php echo $product_category_keywords; ?>" required>
                                    </div>
                                    <div class="form-group">
                                        <label for="product_category_description">SEO Description <span style="color: red;">*</span></label>
                                        <input type="text" class="form-control" id="product_category_description" name="product_category_description" value="<?php echo $product_category_description; ?>" required>
                                    </div>
                                    <div class="form-group">
...
<script type="text/javascript">
    $("#proCollectionActive").addClass("active");
    $("#proCollectionActive").parent().parent().addClass("treeview active");
    $("#proCollectionActive").parent().addClass("in");
</script>
</body>
</html>
