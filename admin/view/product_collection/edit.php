...
if (isset($_POST['btnEditProduct'])) {
    ...
    if ($product_category_name === '') {
        ...
        $sqlInsertProduct = "UPDATE tbl_product_collection SET $customArray WHERE product_category_id= $product_id";
...
//getting data
$sql_data = "SELECT * FROM tbl_product_collection WHERE product_category_id = $product_id";
