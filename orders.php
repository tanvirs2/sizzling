        ...
        <div class="container">
            <div class="pagination-area">
                ...
                <div class="redchili-pagination"><!-- Breadcrumb NavXT 6.0.4 -->
                    <span property="itemListElement" typeof="ListItem"><a property="item" typeof="WebPage" title="Go to Aangon." href="index.php" class="home"><span property="name">Aangon</span></a><meta property="position" content="1"></span> &gt; <span property="itemListElement" typeof="ListItem"><span property="name">Dashboard</span><meta property="position" content="2"></span></div>							</div>
        </div>
    </div>
                                            ...
                                            <tr>
                                                ...
                                                <td style="width: 10%;">
                                                    <?php if ($obj->order_status == 'Received'): ?>
                                                        <label class="label label-default"><?php echo $obj->order_status; ?></label>
