...
$sqlCategory = "SELECT product_category_id,product_category_name,product_category_description, product_category_keywords FROM tbl_product_collection WHERE product_category_id = $product_category_id";
...
<head>
    ...
    <title><?php echo $config['SITE_NAME']; ?> | <?php echo $productListCategory->product_category_name; ?></title>
            ...
            <div class="htc__product__container">
                ...
                <div class="row">
                    <div class="product__list">
                        <?php
                        $array = array();
                        $sql = "SELECT * FROM tbl_product WHERE product_status='Active' AND product_collection_id = $product_category_id ORDER BY product_id";
                        ...
                        $lpm1 = $lastpage - 1;
                        $sql2 = "SELECT * FROM tbl_product WHERE product_collection_id = $product_category_id ORDER BY product_id DESC LIMIT $start ,$limit";
                        ...
                        if ($lastpage > 1) {
                            ...
                            if ($page > $counter + 1) {
                                $pagination .= "<li class='page-item'><a href=\"$targetpage?page=$prev&id=$product_category_id\">Prev</a></li>";
                            }
                            if ($lastpage < 7 + ($adjacents * 2)) {
                                for ($counter = 1; $counter <= $lastpage; $counter++) {
                                    if ($counter == $page) {
                                        ...
                                        $pagination .= "<li class='page-item'><a class='page-link' href=\"$targetpage?page=$counter&id=$product_category_id\">$counter</a></li>";
                                    }
                                }
                        ...
                        <?php if ($total > 0): ?>
                                    ...
                                    <div class="product foo">
                                        <div class="product__inner">
                                            ...
                                            <div class="pro__thumb">
                                                <a href="products?name=<?php echo $productList->product_title; ?>">
                                                    <img src="upload/product_image/<?php echo $productList->product_image; ?>" alt="<?php echo $productList->product_title; ?>">
                                                </a>
                                            </div>
                                            <div class="product__hover__info">
                                                <ul class="product__action">
                                                    <li><a title="Quick View" class="quick-view modal-view detail-link" href="products?name=<?php echo $productList->product_title; ?>"><span class="ti-plus"></span></a></li>
                                        ...
                                        <div class="product__details">
                                            <h2><a href="products?name=<?php echo $productList->product_title; ?>"><?php echo $productList->product_title; ?></a></h2>
                                            <ul class="product__price">
                                                <?php if($productList->product_old_price != '0.00') : ?>
                                                    <li class="old__price">৳<?php echo $productList->product_old_price; ?></li>
                                                <?php endif; ?>
                            ...
                            <?php endforeach; ?>
                        <?php else: ?>
                            <p style="text-align: center">No products in this collection has been uploaded yet!</p>
                        <?php endif; ?>
                        <!-- End Single Product -->
                    </div>
                </div>
